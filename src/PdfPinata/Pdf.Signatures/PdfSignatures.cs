...
/// to believe any of it is cryptography, and lives in <c>PdfPinata.Signing</c>.
/// </remarks>
public static class PdfSignatures
{
    ...
    {
        return value.Elements["/Contents"] is PdfString contents ? PdfEncoders.RawEncoding.GetBytes(contents.Value) : [];
    }
