...
The invoice document is created with the PinataLayout document object model and then rendered to PDF with PdfPinata.
...
void CreatePage()
{
    // Each PinataLayout document needs at least one section.
