# Mix PinataLayout and PdfPinata

Demonstrates how to mix PinataLayout and PdfPinata.


## Creating the Document

We create a PdfDocument, not a (PinataLayout) Document:

```cs
static void Main()
{
    DateTime now = DateTime.Now;
    string filename = "MixPinataLayoutAndPdfPinata.pdf";
    filename = Guid.NewGuid().ToString("D").ToUpper() + ".pdf";
    PdfDocument document = new PdfDocument();
    document.Info.Title = "PdfPinata XGraphic Sample";
    document.Info.Author = "Stefan Lange";
    document.Info.Subject = "Created with code snippets that show the use of graphical functions";
    document.Info.Keywords = "PdfPinata, XGraphics";
...
Here we create a PinataLayout Document object to draw the content of this page:
...
static void SamplePage1(PdfDocument document)
{
    ...
    gfx.DrawString("The following paragraph was rendered using PinataLayout:", font, XBrushes.Black,
    new XRect(100, 100, page.Width - 200, 300), XStringFormats.Center);
    
    // You always need a PinataLayout document for rendering.
    ...
    para.Format.Font.Color = PinataLayout.DocumentObjectModel.Colors.DarkGray;
    para.Format.Font.Color = PinataLayout.DocumentObjectModel.Colors.DarkGray;
    ...
    PinataLayout.Rendering.DocumentRenderer docRenderer = new DocumentRenderer(doc);
...
This page contains six pages, created with PinataLayout and scaled down to fit on one page:
