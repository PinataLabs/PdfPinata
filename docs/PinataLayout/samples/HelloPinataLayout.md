...
Shows various features of PinataLayout including table of contents, tables, bookmarks, text formatting and font styles, charts, ...
...
static void Main()
{
    // Create a PinataLayout document
    Document document = Documents.CreateDocument();
    
    //string ddl = PinataLayout.DocumentObjectModel.IO.DdlWriter.WriteToString(document);
    PinataLayout.DocumentObjectModel.IO.DdlWriter.WriteToFile(document, "PinataLayout.mdddl");
...
{
    // Create a new PinataLayout document
    Document document = new Document();
    document.Info.Title = "Hello, PinataLayout";
    document.Info.Subject = "Demonstrates an excerpt of the capabilities of PinataLayout.";
