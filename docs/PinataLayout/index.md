...
PinataLayout is a document generator.
...
PinataLayout will do the layout creating page breaks as needed.
PinataLayout will create PDF documents.
...
// With PinataLayout, we don’t add pages, we add sections (at least one):
...
// With PinataLayout you can create PDF or RTF. Just select the appropriate renderer:
