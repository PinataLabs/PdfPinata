...
`src/PdfPinata/Pdf/PdfPageSheet.cs` is a new 292-line `internal sealed class`, constructed with a
...
`src/PdfPinata.Test/Drawing/PageBleedTests.cs`, bringing the file to 26:
