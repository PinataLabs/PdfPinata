...
> `dotnet run --project src/SampleApp -- run -e Text`
>
...
TextFormatter was provided because it was one of the "most wanted" features. But it is better and easier to use PinataLayout to format paragraphs...
