...
Note:  Consider using PinataLayout instead of PdfPinata for large documents. You can use many attributes to format text and you get the line breaks and page breaks for free.
...
I wrote it before: Consider using PinataLayout instead of PdfPinata for large documents. You can use many attributes to format text and you get the line breaks and page breaks for free.
