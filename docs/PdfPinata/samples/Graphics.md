...
> `dotnet run --project src/SampleApp -- run -e Vectors`
>
...
static void Main()
{
    ...
    s_document.Info.Title = "PdfPinata XGraphic Sample";
    ...
    s_document.Info.Keywords = "PdfPinata, XGraphics";
...
public void DrawTitle(PdfPage page, XGraphics gfx, string title)
{
    ...
    format.Alignment = XStringAlignment.Near;
    format.LineAlignment = XLineAlignment.Far;
    gfx.DrawString("Created with " + PdfPinata.ProductVersionInfo.Producer, font, XBrushes.DarkOrchid, rect, format);
