...
#
#   PdfPinata.1.1.0.nupkg  ->  PdfPinata.1.1.0.cdx.json
#
...
#   project     Project directory name, e.g. PdfPinata.Skia. Expected to contain
...
for project in "$@"; do
  ...
  # --recursive matters: the backend and layout packages reach most of their closure
